<template>
  ...
  <div>
    ...
    <p id="all-visited-message" v-if="areAllVisited">You have visited all states and the District of Columbia!</p>
  </div>
...
export default {
  ...
  computed: {
    ...
    areAllVisited() {
      // returns boolean (true if totalVisited = length of states array)
